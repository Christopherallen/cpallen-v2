  ...
  <section className="intro">
    <div className="container">
      <div className="intro__wrapper">
        ...
        <p className="intro__description" data-sal="slide-up" data-sal-duration="900" data-sal-delay="400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer risus est, bibendum eget leo at, interdum pharetra felis. Etiam sed est in nibh bibendum faucibus a id justo. Vestibulum sit amet diam.</p>
